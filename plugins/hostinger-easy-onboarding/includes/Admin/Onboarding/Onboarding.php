...
class Onboarding {
    ...
    private function get_reach_step(): Step {
        ...
        $step->set_description( __( 'Collect emails from forms on your site and start sending on-brand email campaigns – all powered by AI.', 'hostinger-easy-onboarding' ) );

        $primary_button = new Button( __( 'Try Hostinger Reach', 'hostinger-easy-onboarding' ) );
